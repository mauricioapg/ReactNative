...
buscarAtivos(){
    fetch("http://192.168.1.162/ativosceb/api/ativos?condicao=Em uso")
    .then(res => res.json())
    .then(res => {this.setState({qtdeAtivos: res})})
}

buscarDescontinuados(){
  fetch("http://192.168.1.162/ativosceb/api/ativos?condicao=Descontinuado")
  .then(res => res.json())
          ...
          <View style={styles.container}>
              <View style={{flexDirection: "row", marginTop: 10, alignSelf: "center"}}>
                <View style={styles.painelAtivos}>
                    ...
                    <Text style={styles.txtQtdeAtivos}>120</Text>  
                </View>
                <View style={styles.painelDescontinuados}>
                  <Text style={{fontSize: 15}}>Descontinuados</Text>
                    <Text style={styles.txtQtdeDescontinuados}>35</Text>
                </View>
              </View>
